...
const CaseSchema = new mongoose.Schema(
  {
    ...
    // Score computed with similarCases = [] — shows the marginal value of vector retrieval
    score_without_retrieval: { type: Number, default: null },
    score_breakdown: {
    ...
    mongodb_via: { type: String, default: 'mcp' },
